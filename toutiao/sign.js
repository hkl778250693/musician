var params = {
    location:{
        "ancestorOrigins": {},
        "href": "https://www.toutiao.com/c/user/token/MS4wLjABAAAAzHj3Nx8o7swEMOeE61Y8tzeXORNWzcXvBa7NNxQhSFg",
        "origin": "https://www.toutiao.com",
        "protocol": "https:",
        "host": "www.toutiao.com",
        "hostname": "www.toutiao.com",
        "port": "",
        // "pathname": "/c/user/token/MS4wLjABAAAAzHj3Nx8o7swEMOeE61Y8tzeXORNWzcXvBa7NNxQhSFg",
        "pathname": "/",
        "search": "",
        "hash": ""
    },
    navigator:{
        ...
        mimeTypes: {
            ...
            1: {type: "application/x-google-chrome-pdf", suffixes: "pdf", description: "Portable Document Format", enabledPlugin: "Plugin"},
            2: {type: "application/x-nacl", suffixes: "", description: "Native Client Executable", enabledPlugin: "Plugin"},
            3: {type: "application/x-pnacl", suffixes: "", description: "Portable Native Client Executable", enabledPlugin: "Plugin"},
            length: 4,
            "application/pdf": {type: "application/pdf", suffixes: "pdf", description: "", enabledPlugin: "Plugin"},
            "application/x-google-chrome-pdf": {type: "application/x-google-chrome-pdf", suffixes: "pdf", description: "Portable Document Format", enabledPlugin: "Plugin"},
            "application/x-nacl": {type: "application/x-nacl", suffixes: "", description: "Native Client Executable", enabledPlugin: "Plugin"},
            "application/x-pnacl": {type: "application/x-pnacl", suffixes: "", description: "Portable Native Client Executable", enabledPlugin: "Plugin"},
        },
        onLine: true,
        permissions: {},
        platform: "Win32",
        plugins: {
            0: {0: "MimeType", "application/x-google-chrome-pdf": "MimeType", name: "Chrome PDF Plugin", filename: "internal-pdf-viewer", description: "Portable Document Format", length: 1},
            1: {0: "MimeType", "application/pdf": "MimeType", name: "Chrome PDF Viewer", filename: "mhjfbmdgcfjbbpaeojofohoefgiehjai", description: "", length: 1},
            2: {
                0: "MimeType",
                1: "MimeType",
            ...
            length: 3,
            "Chrome PDF Plugin": {0: "MimeType", "application/x-google-chrome-pdf": "MimeType", name: "Chrome PDF Plugin", filename: "internal-pdf-viewer", description: "Portable Document Format", length: 1},
            "Chrome PDF Viewer": {0: "MimeType", "application/pdf": "MimeType", name: "Chrome PDF Viewer", filename: "mhjfbmdgcfjbbpaeojofohoefgiehjai", description: "", length: 1},
            "Native Client": {
                0: "MimeType",
                1: "MimeType",
                "application/x-nacl": "MimeType",
...
console.log("zhiqian",window.byted_acrawler)
var glb;
                    ...
                    _ < 1) {
                        if ((_ = x) > 14)
                            ...
                            q = z[S--],
                                I = z[S--],
                                _ = z[S--],
                                _.x === L ? _.y >= 1 ? z[++S] = M(b, _.c, _.l, q, _.z, I, null, 1) : (z[++S] = M(b, _.c, _.l, q, _.z, I, null, 0),
                                    _.y++) : z[++S] = _.apply(I, q);
                        else if (_ > 5)
                            C = z[S--],
                                z[S] = z[S] != C;
...
n = window.byted_acrawler.sign;
// console.log(n)
result = n.call(window.byted_acrawler,i);
console.log(result);
